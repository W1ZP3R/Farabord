                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="col-md-2">
                        <a href="#htab3" role="tab" data-toggle="tab" class="gray-bg">
                            <div class="p-10 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="1200">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="tab-content clear-style">
                                ...
                                <div class="tab-pane text-center" id="pill-2">
                                    <div class="col-md-10 col-centered">

                                        <div class="col-md-3 col-sm-2 col-xs-6">
                                            <h5>بازی</h5>
                                            <div class="knob-container hvr-pulse-grow">
                                                <input class="knob" data-fgcolor="#377DBA" data-thickness=".1" data-animate-value="50" value="0" data-displayInput="false" data-readOnly="true">
                                                <div class="knob-text">
                                                    <img src="<?php echo get_template_directory_uri();?>/images/icon/speed-load-1.svg" width="89%" style="display: block;margin: 6px auto" />
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane text-center" id="pill-3" data-speed="500" data-easing="easeOutQuad" data-start="1000">
                                    <div class="col-md-10 col-centered">

                                        <div class="col-md-3 col-sm-2 col-xs-6">
                                            <h5>بازی</h5>
                                            <div class="knob-container hvr-pulse-grow">
                                                <input class="knob" data-fgcolor="#377DBA" data-thickness=".1" data-animate-value="65" value="0" data-displayInput="false" data-readOnly="true">
                                                <div class="knob-text">
                                                    <img src="<?php echo get_template_directory_uri();?>/images/icon/speed-load-1.svg" width="89%" style="display: block;margin: 6px auto" />
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane text-center" id="pill-4">
                                    <div class="col-md-10 col-centered">

                                        <div class="col-md-3 col-sm-2 col-xs-6">
                                            <h5>بازی</h5>
                                            <div class="knob-container hvr-pulse-grow">
                                                <input class="knob" data-fgcolor="#377DBA" data-thickness=".1" data-animate-value="80" value="0" data-displayInput="false" data-readOnly="true">
                                                <div class="knob-text">
                                                    <img src="<?php echo get_template_directory_uri();?>/images/icon/speed-load-1.svg" width="89%" style="display: block;margin: 6px auto" />
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane text-center" id="pill-5">
                                    <div class="col-md-10 col-centered">

                                        <div class="col-md-3 col-sm-2 col-xs-6">
                                            <h5>بازی</h5>
                                            <div class="knob-container hvr-pulse-grow">
                                                <input class="knob" data-fgcolor="#377DBA" data-thickness=".1" data-animate-value="100" value="0" data-displayInput="false" data-readOnly="true">
                                                <div class="knob-text">
                                                    <img src="<?php echo get_template_directory_uri();?>/images/icon/speed-load-1.svg" width="89%" style="display: block;margin: 6px auto" />
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 p-20">
                                        <div class="pv-30 ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                                            ...
                                            <br>
                                            <h5>2 . حضور در محل و امکان سنجی</h5>
                                        </div>
                                    </div>
                                    <div class="col-md-4 p-20">
                                        <div class="pv-30 ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-centered">
                                <div class="f-15 text-justify p-80 clearfix" dir="rtl" data-animation-effect="fadeInDownSmall" data-effect-delay="500">
                                    <h2 class="text-right p-30" style="color: #09AFDF">
                                        <?php
                                            $post_id = 58;
                                            $queried_post = get_post($post_id);
                                            $title = $queried_post->post_title;
